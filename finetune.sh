...
/home/matthew/miniconda3/envs/rocm/bin/deepspeed ./llava/train/train_mem.py \
    --deepspeed ./scripts/zero3.json \
    --model_name_or_path /home/matthew/models/llava-v1.5-7b \
    --version v1 \
    --data_path ./C3L/high_I2C_question.json \
    --image_folder /home/matthew/fiftyone/coco-2014/train/data \
    --vision_tower /home/matthew/models/clip-vit-large-patch14-336 \
    --pretrain_mm_mlp_adapter /home/matthew/models/llava-v1.5-7b/mm_projector.bin \
